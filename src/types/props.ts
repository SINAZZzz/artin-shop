...
export type AlignItemsType = 'baseline' | 'center' | 'end' | 'flex-end' | 'flex-start' | 'self-end' | 'self-start' | 'start' | 'stretch';
export type PositionType = 'absolute' | 'fixed' | 'inherit' | 'initial' | 'relative' | 'unset' | 'sticky' ;
export type JustifyContentType = 'center' | 'justify' | 'end' | 'left'| 'right' | 'start'| 'space-around'| "space-between" | "space-evenly" ;
