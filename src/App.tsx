  ...
  return (
    <Box>
      ...
      <Box mx={{ xs: '1rem', md: '4rem' }}>
        ...
        <Grid item xs={6}>
          <Box display='flex' alignItems='end' borderRadius='10px' width='100%' my='4rem' height='20rem' style={{background: 'linear-gradient(to top, rgba(157,3,60,100%),rgba(220,2,120,100%))'}}>
        ...
        <Grid item xs={6}>
          <Box display='flex' alignItems='end' borderRadius='10px' width='100%' my='4rem' height='20rem' style={{background: 'linear-gradient(to top, rgba(14,56,176,100%),rgba(120,84,247,100%))'}}>
            <Box display='flex' alignItems='end' zIndex={0} position='absolute' height='43%'>
              <Box component='span' width='5rem' height='80%' mr={{md:'1.5rem' , xs:'2rem'}} borderRadius='30px 30px 0px 0px' style={{background: 'rgba(21,126,247,15%)'}}></Box>
            </Box>
            <Box display='flex' alignItems='start' position='absolute' alignContent='start' justifyContent='end' alignSelf='start' zIndex={0}  height='43%' width='100%' left='0'>
              <Box component='span' width='5rem' height='80%' ml='5.5rem' borderRadius='0px 0px 30px 30px' style={{background: 'rgba(21,126,247,15%)'}}></Box>
            </Box>
            <Box display='flex' width='100%' height='100%' justifyContent='space-between' >
              <Box zIndex={1} display='flex' flexDirection='column' justifyContent='center' alignItems='start' height='100%' mr='2rem'>
                  <Title title='فروش تابستانه' fontSize='1.5rem' color='white' fontWeight={'bold'} />
              ...
              <Box zIndex={1} display='flex' flexDirection='column' justifyContent='end' alignItems='end' height='100%'>
                <Box component='img' src='https://s8.uupload.ir/files/air-max-270-react-se_c1y4.png' width='100%'  />
              </Box>
            </Box>
          </Box>
        </Grid>
